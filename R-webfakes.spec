...
Version  : 1.2.0
Release  : 30
URL      : https://cran.r-project.org/src/contrib/webfakes_1.2.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/webfakes_1.2.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684343869
